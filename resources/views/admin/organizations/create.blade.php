<x-admin-master>
    ...
    @section('page-title')
        Add Organization | MEX LMS Admin
    @endsection
    ...
    @section('content')
        <h1 class="m-3"><span>Add</span> an Organization</h1>
                ...
                <form action="{{ route('organization.store') }}" method="post">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-2">
                                <label for="zip" class="mt-3">Zip Code <span class="text-danger">(Required)</span></label>
                                <input type="number" class="form-control no-spinners" name="zip">
                            </div>
                            <div class="col-sm-6">
                                <label for="image" class="mt-3">Logo</label>
